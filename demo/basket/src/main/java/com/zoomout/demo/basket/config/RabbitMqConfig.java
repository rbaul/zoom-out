...
public class RabbitMqConfig {
	...
	public TopicExchange exchange() {
		return new TopicExchange(BasketAsyncApi.BASKET_TOPIC_EXCHANGE);
	}
	...
	public RabbitTemplate rabbitTemplate(final ConnectionFactory connectionFactory, ObjectMapper objectMapper) {
		...
		rabbitTemplate.setExchange(BasketAsyncApi.BASKET_TOPIC_EXCHANGE);
		rabbitTemplate.setRoutingKey(BasketAsyncApi.BASKET_ROUTING_KEY);
